...
# A sample path:
# path = r'..\data\genuine\2000\2000_s1.jpg'
...
def testFeature_1_2_7():
    ...
    for j in range(NUM_OF_FEATURES):
        ...
        feature_dir = r'..\data\templates\2000\Feature ' + str(j+1)
...
def testFeature_11():
    ...
    center_crop = test_img[100:350, 200:900]
    ...
    # Thread check
    thread_crop = test_img[100:350, 580:610]
    ...
    status = (ratio > 0.1) and (thread_ratio > 0.005)
    print(f'Base magenta ratio: {ratio:.3f}, Thread shift ratio: {thread_ratio:.3f}')
